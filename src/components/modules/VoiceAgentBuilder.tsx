...
const VoiceAgentBuilder: React.FC = () => {
  const { darkMode, voiceAgents, addVoiceAgent } = useStore();
          ...
          <div key={agent.id} className="card p-6 hover:shadow-lg transition-all duration-200">
            ...
            <div className="space-y-2 mb-4">
              <div className="text-sm">
                ...
                <span className="ml-2 capitalize">{agent.persona.tone}</span>
              </div>
              <div className="text-sm">
                <span className="text-muted-foreground">Style:</span>
                <span className="ml-2 capitalize">{agent.persona.style}</span>
              </div>
              <div className="text-sm">
                <span className="text-muted-foreground">Language:</span>
                <span className="ml-2">{agent.defaultLanguage}</span>
              </div>
            </div>
