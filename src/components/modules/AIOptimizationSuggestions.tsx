    ...
    <div className="p-6 bg-background min-h-screen text-foreground">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold gradient-text mb-2">A I Optimization Suggestions</h1>
      ...
      <div className="card p-8 text-center">
        ...
        <h2 className="text-xl font-semibold mb-2">A I Optimization Suggestions</h2>
